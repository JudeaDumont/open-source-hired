...
import {
    createLinesFromLink
} from "../../../EditableHighlighter/Components/LineComponent/CreateLines/InnerFunctions/CreateLinesFromLink";
...
describe('createLinesFromValidLink', () => {
    ...
    it('createLinesFromValidLink', () => {
        ...
        createLinesFromLink({from: "line-a", to: "line-a"}, linkLineElementsC);
