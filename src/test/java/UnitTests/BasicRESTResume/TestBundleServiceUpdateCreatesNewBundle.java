...
class TestBundleServiceUpdateCreatesNewBundle {
    ...
    void t() throws DuplicatePrimaryKeyException {
        ...
        int bundleId = bundleService.update(resumeBundlePersist);
        ...
        ResumeBundlePersist resumeBundlePersist3 = new ResumeBundlePersist(
                UUID.randomUUID(),
                "jeff",
                ""
        );

        bundleService.update(resumeBundlePersist3);

        bundleService.delete(resumeBundlePersist3);
    }
}
